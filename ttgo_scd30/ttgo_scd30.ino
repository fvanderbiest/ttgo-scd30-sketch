...
void setup()
{
  ...
  if (scd.begin(Wire, true) == false){
    Serial.println("Air sensor not detected. Please check wiring. Freezing...");
    while (1);
  }
  scd.setMeasurementInterval(2);
  scd.setAltitudeCompensation(300);
  scd.setAutoSelfCalibration(0);
  scd.setTemperatureOffset(4); // FIXME
...
void performCalibration() {
  scd.setForcedRecalibrationFactor(415);
}
